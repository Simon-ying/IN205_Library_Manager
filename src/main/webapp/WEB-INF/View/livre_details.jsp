	      ...
	      <form action="/LibraryManager/livre_details?id=${book.id }" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="titre" type="text" value="${book.titre}" name="titre"> <!-- TODO : remplacer titreDuLivre par le titre du livre -->
	            <label for="titre">Titre</label>
	          </div>
	        </div>
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="auteur" type="text" value="${book.auteur}" name="auteur"> <!-- TODO : remplacer auteurDuLivre par l'auteur du livre -->
              ...
              <tbody id="results">
				<c:if test="${!borrowList.isEmpty()}">
					<c:forEach items="${borrowList}" var="emprunt">
						<tr>
                  			<td>${emprunt.member.prenom} ${emprunt.member.nom}</td>
