        ...
        <div class="row">
	      <form action="/LibraryManager/membre_details?id=${membre.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <select id="abonnement" name="abonnement" class="browser-default">
	              ...
	              <option value="VIP" ${(membre.abon == "VIP") ? " selected" : ""}>Abonnement VIP</option>
	              <option value="BASIC" ${(membre.abon == "BASIC") ? " selected" : ""}>Abonnement BASIC</option>
	              <option value="PREMIUM" ${(membre.abon == "PREMIUM") ? " selected" : ""}>Abonnement PREMIUM</option>
